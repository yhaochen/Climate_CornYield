...
# read orgininal data
for (q in 1:18){
  dir.create(paste("/storage/work/h/hxy46/Countywise/Data/MACAv2-METDATA_hind/",modelnames[q],"_proj",sep=""),recursive = TRUE)
  ...
  if ((i%%5==1)&(years[i]<2005)){
    ...
    Tmin_file<-paste("/gpfs/group/kzk10/default/private/data_archive/MACAv2-METDATA/raw/macav2metdata_tasmin_",modelnames[q],"_r1i1p1_historical_"
                     ,years[i],"_",years[i]+4,"_CONUS_daily.nc",sep="")
    Pr_file<-paste("/gpfs/group/kzk10/default/private/data_archive/MACAv2-METDATA/raw/macav2metdata_pr_",modelnames[q],"_r1i1p1_historical_"
                   ,years[i],"_",years[i]+4,"_CONUS_daily.nc",sep="")
    RHmax_file<-paste("/gpfs/group/kzk10/default/private/data_archive/MACAv2-METDATA/raw/macav2metdata_rhsmax_",modelnames[q],"_r1i1p1_historical_"
                      ,years[i],"_",years[i]+4,"_CONUS_daily.nc",sep="")
    RHmin_file<-paste("/gpfs/group/kzk10/default/private/data_archive/MACAv2-METDATA/raw/macav2metdata_rhsmin_",modelnames[q],"_r1i1p1_historical_"
                      ,years[i],"_",years[i]+4,"_CONUS_daily.nc",sep="")
